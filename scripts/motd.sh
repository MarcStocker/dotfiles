...
banner () {
	...
	echo -e "${PURPLE}═════════════════════════════════════════════════════════${NOCOLOR}"
	echo -e "${CYAN}   -------------------------------------------------${NOCOLOR}"
	echo -e "${CYAN}   --  ${PURPLE}__________        __   .__                 ${CYAN}--${NOCOLOR}"
	echo -e "${CYAN}   --  ${PURPLE}\\______   \\ ____ |  | _|__|____    ____    ${CYAN}--"
	echo -e "${CYAN}   --  ${PURPLE} |       _//  _ \\|  |/ /  \\__  \\  /    \\   ${CYAN}--"
	echo -e "${CYAN}   --  ${PURPLE} |    |   {  <_> }    <|  |/ __ \\|   |  \\  ${CYAN}--"
	echo -e "${CYAN}   --  ${PURPLE} |____|_  /\\____/|__|_ \\__{____  /___|  /  ${CYAN}--"
	echo -e "${CYAN}   --  ${PURPLE}        \\/            \\/       \\/     \\/   ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE}  _________                                 ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE} /   _____/ ______________  __ ___________  ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE} \\_____  \\_/ __ \\_  __ \\  \\/ // __ \\_  __ \\ ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE} /        \\  ___/|  | \\/\\   /\\  ___/|  | \\/ ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE}/_______  /\\___  >__|    \\_/  \\___  >__|    ${CYAN}--"
	echo -e "${CYAN}   -- ${PURPLE}        \\/     \\/                 \\/     ${PURPLE}  ${VerNum} ${CYAN}--"
